...
public class JellyMonster extends BaseEnemy
{
    private       TargettingSystem targettingSystem;
    private final App              app;

    public JellyMonster(final GraphicID _gid, final App _app)
    {
        super(_gid, _app);
    ...
    public void initialise(final EntityDescriptor entityDescriptor)
    {
        ...
        targettingSystem.speedX = 1.0f;
        targettingSystem.speedY = 1.0f;
