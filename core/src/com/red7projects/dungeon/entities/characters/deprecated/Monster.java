...
public class Monster extends BaseEnemy
{
    ...
    public Monster(final GraphicID _gid, final App _app)
    {
        super(_gid, _app);
    ...
    public void initialise(final EntityDescriptor entityDescriptor)
    {
        ...
        else if (gid == GraphicID.G_JELLY_MONSTER)
        {
        ...
        else
        {
            ...
            speedTemp = 0.5f + MathUtils.random(0.5f);
        }
