...
public class Gfx
{
    ...
    public static final int   _VIEW_WIDTH       = 2560;                 // This is the resolution that full screen
    public static final int   _VIEW_HEIGHT      = 1440;                 // images should be defined as
    ...
    public static void setPPM(final float newPPM)
    {
        if (!AppConfig.camerasReady)
        {
            if (newPPM != _PPM)
            {
                ...
                _SCENE_WIDTH  = (_VIEW_WIDTH / _PPM);
                _SCENE_HEIGHT = (_VIEW_HEIGHT / _PPM);
            }
        }
    }
